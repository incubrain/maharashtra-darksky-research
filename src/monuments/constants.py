"""
Monument data and display constants.
...
Each entry: (name, monument_type, place, taluka, district, notification_status)
"""
...
# Format: (name, monument_type, place, taluka, district, notification_status)
MONUMENTS = [
    # ═══ RATNAGIRI DIVISION ═══
    # District Palghar
